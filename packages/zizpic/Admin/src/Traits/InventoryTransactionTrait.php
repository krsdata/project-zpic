...
use Inventory\Admin\Exceptions\InvalidQuantityException;
use Inventory\Admin\Exceptions\NotEnoughStockException;
use Inventory\Admin\Exceptions\StockNotFoundException;
use Inventory\Admin\Exceptions\InvalidTransactionStateException;
use Inventory\Admin\InventoryServiceProvider;
...
use CommonMethodsTrait;
     ...
     *
     * @throws \Inventory\Admin\Exceptions\NotEnoughStockException
     * @throws \Inventory\Admin\Exceptions\InvalidQuantityException
...
//        ];
        ...
        $result = InventoryTransactionState::lists( 'state' );
        return $result;
    }
