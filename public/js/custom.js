...
jQuery(function($) {
    ...
    var oTable = $('#stock-by-location').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: baseURL + '/inventories/locations/1/getStock',
            data: function(d) {
        ...
        columns: [
            ...
            {data: 'serial_no', name: 'serial_no', 'title': 'Stock S/N'},
            {data: 'quantity', name: 'quantity', 'title': 'Stock Quantity'},
...
// Delete Function
    ...
    $('#addLocation select[name="inventory"]').change(function() {
        if ($(this).val() != '') {
